...
local full_display_sprite = {
	north = {
		filename = "__epicombinator__/graphics/entities/filter-combinator-display.png",
		width = 15,
		height = 11,
		scale = main.and_symbol_sprites.north.scale,
		shift = main.and_symbol_sprites.north.shift,
		hr_version = {
			filename = "__epicombinator__/graphics/entities/hr-filter-combinator-display.png",
			width = 30,
			height = 22,
